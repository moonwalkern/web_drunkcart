...
class ControllerStep3 extends Controller {
	...
	public function index() {		
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            $output .= 'define(\'AJAX_PHOTO_URL\', \'' . addslashes($this->request->post['pic_upload_url']) . '\');' . "\n";
			$output .= '?>';				
        ...
        if (isset($this->error['pic_upload_url'])) {
			$this->data['error_pic_upload_url'] = $this->error['pic_upload_url'];
		} else {
			$this->data['error_pic_upload_url'] = '';
		}
        ...
        if (isset($this->request->post['pic_upload_url'])) {
			$this->data['pic_upload_url'] = html_entity_decode($this->request->post['pic_upload_url']);
		} else {
			$this->data['pic_upload_url'] = 'http://localhost/';
		}
	...
	private function validate() {
        ...
        if (!$this->request->post['pic_upload_url']) {
			$this->error['pic_upload_url'] = 'Pic Upload URL required!';
		}
