  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    ...
    <fieldset>
      <table class="form">
        ...
        <tr>
          <td>Pic Upload URL:</td>
          <td><input type="text" name="pic_upload_url" value="<?php echo $pic_upload_url; ?>" />
            <br />
            <?php if ($error_pic_upload_url) { ?>
            <span class="required"><?php echo $error_pic_upload_url; ?></span>
            <?php } ?></td>
        </tr>
      </table>
    </fieldset>
