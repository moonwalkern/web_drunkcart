...
//                );
//            }
//            echo print_R($data['attribute_values_save'],TRUE);
//            die;  
	...
	protected function getForm() {
		...
		$this->data['entry_image_small'] = $this->language->get('entry_image_small');
		$this->data['entry_top'] = $this->language->get('entry_top');
		$this->data['entry_column'] = $this->language->get('entry_column');		
		$this->data['entry_sort_order'] = $this->language->get('entry_sort_order');
		$this->data['entry_status'] = $this->language->get('entry_status');
		$this->data['entry_layout'] = $this->language->get('entry_layout');
        $this->data['entry_attribute_name'] = $this->language->get('entry_attribute_name');
        $this->data['entry_attribute_type'] = $this->language->get('entry_attribute_type');
        ...
        if (isset($this->request->post['image_small'])) {
			$this->data['image_small'] = $this->request->post['image_small'];
		} elseif (!empty($category_info)) {
			$this->data['image_small'] = $category_info['image_small'];
		} else {
			$this->data['image_small'] = '';
		}
        ...
        if (isset($this->request->post['image_small']) && file_exists(DIR_IMAGE . $this->request->post['image_small'])) {
			$this->data['thumb_small'] = $this->model_tool_image->resize($this->request->post['image_small'], 100, 100);
		} elseif (!empty($category_info) && $category_info['image_small'] && file_exists(DIR_IMAGE . $category_info['image_small'])) {
			$this->data['thumb_small'] = $this->model_tool_image->resize($category_info['image_small'], 100, 100);
		} else {
			$this->data['thumb_small'] = $this->model_tool_image->resize('no_image.jpg', 100, 100);
		}
        ...
        $this->data['attribute_types'] = array();
        
        $attribute_types = 'input,select,radio,year';
        $array_attribute_types = explode(",",$attribute_types );
        foreach ($array_attribute_types as $array_attribute_type) {
    		$this->data['attribute_types'][] = array(
    					'name'      => $array_attribute_type
    				);  
		}	
        $this->data['attribute_row'] = 1;
        
        $this->load->model('catalog/category');
        $this->data['attribute_groups'] = array();
        if(isset($this->request->get['category_id'])){
            $results = $this->model_catalog_category->getCategoryAttributes($this->request->get['category_id']);
        
            $this->data['attribute_groups'] = $results;
        }
