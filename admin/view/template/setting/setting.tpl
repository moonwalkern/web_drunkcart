      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-image">
          <table class="form">
            ...
            <tr>
              <td><span class="required">*</span> <?php echo $entry_image_category_search; ?></td>
              <td><input type="text" name="config_image_category_search_width" value="<?php echo $config_image_category_search_width; ?>" size="3" />
                x
                <input type="text" name="config_image_category_search_height" value="<?php echo $config_image_category_search_height; ?>" size="3" />
                <?php if ($error_image_cart) { ?>
                <span class="error"><?php echo $error_image_cart; ?></span>
                <?php } ?></td>
            </tr>
