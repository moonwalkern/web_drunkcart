...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="view/image/payment/payu-logo.png" alt="" /></h1>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          <tr>
		   ...
		   <tr>
            <td><span class="required">*</span> <?php echo $entry_salt; ?></td>
            <td><input type="text" name="payu_salt" value="<?php echo $payu_salt; ?>" />
              <?php if ($error_salt) { ?>
