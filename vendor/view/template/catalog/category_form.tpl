...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-data"><?php echo $tab_data; ?></a><a href="#tab-design"><?php echo $tab_design; ?></a><a href="#tab-attribute"><?php echo $tab_attribute; ?></a></div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr>
              <td><?php echo $entry_image_small; ?></td>
              <td valign="top"><div class="image"><img src="<?php echo $thumb_small; ?>" alt="" id="thumb_small" />
                  <input type="hidden" name="image_small" value="<?php echo $image_small; ?>" id="image_small" />
                  <br />
                  <a onclick="image_upload('image_small', 'thumb_small');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#thumb_small').attr('src', '<?php echo $no_image; ?>'); $('#image_small').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
            </tr>
            <tr>
        ...
        <div id="tab-attribute">
          <table id="category_attribute"  class="list">
            <thead>
              <tr>
                <td class="left"><?php echo $entry_attribute_name; ?></td>
                <td class="left"><?php echo $entry_attribute_type; ?></td>
                <td class="left"><?php echo $entry_attribute_values; ?></td>
                <td></td>
                <td></td>
              </tr>
            </thead>
            ...
            <tbody id="attribute-row<?php echo $attribute_row; ?>">
              <tr>
                <td class="left"><input type="text" name="attribute_name[<?php echo $attribute_group['attribute_group_id']; ?>][position]" size="30" value="<?php echo $attribute_group['name']; ?>" /></td>
                <td class="left"><select name="attribute_type[<?php echo $attribute_group['attribute_group_id']; ?>][position]">
                    
                    <?php foreach ($attribute_types as $attribute_type) { ?>
                    <?php if ($attribute_type['name'] == $attribute_group['attribute_group_type']) { ?>
                    <option value="<?php echo $attribute_type['name']; ?>" selected="selected"><?php echo $attribute_type['name']; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $attribute_type['name']; ?>"><?php echo $attribute_type['name']; ?></option>
                    <?php } ?>
                    <?php } ?>
                  </select></td>
                  <td class="left"><input type="text" name="attribute_value[<?php echo $attribute_group['attribute_group_id']; ?>][position]" size="50" value="<?php echo $attribute_group['values']; ?>" /></td>
...
function addAttribute() {	
	...
	html += '  <tr>';
	html += '   <td class="left"><input type="text" name="attribute_name['+ attribute_id +'][position]" size="30" value="" /></td>';
    html += '   <td class="left"><select name="attribute_type['+ attribute_id +'][position]">';
	<?php foreach ($attribute_types as $attribute_type) { ?>
	html += '      <option value="<?php echo $attribute_type['name']; ?>"><?php echo $attribute_type['name']; ?></option>';
	<?php } ?>
	html += '    </select></td>';
	html += '    <td class="left"><input type="text" name="attribute_value['+ attribute_id +'][position]" size="50" value="" /></td>';
	html += '    <td class="left"><a onclick="$(\'#attribute-row' + attribute_row + '\').remove();" class="button"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
	html += '</tbody>';
	
	$('#category_attribute tfoot').before(html);
