...
class ModelCatalogProduct extends Model {
	public function addProduct($data) {
		...
		if ($this->user->getId() != "") {
			$this->db->query("INSERT INTO " . DB_PREFIX . "product_to_vendor SET `product_id` = " . (int)$product_id . ", vendor_id = " . (int)$this->user->getId() );
		}
		
		$this->cache->delete('product');
	}
	public function editProductAttributes($product_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "product SET quantity = " . (int)$data['quantity']  . ", status = " . (int)$data['status'] . ", date_modified = NOW() WHERE product_id = " . (int)$product_id . "");	
	...
	public function editProduct($product_id, $data) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "product_to_vendor WHERE product_id = '" . (int)$product_id . "'");
	...
	public function getProducts($data = array()) {
		...
		if ($this->user->getId() != "") {
			$sql .= " AND pv.vendor_id = " . $this->user->getId() . "";
		}
