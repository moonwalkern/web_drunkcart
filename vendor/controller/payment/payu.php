...
class ControllerPaymentPayu extends Controller {
	...
	public function index() {
        ...
        if (isset($this->error['salt'])) {
			$this->data['error_salt'] = $this->error['salt'];
		} else {
			$this->data['error_salt'] = '';
		}
		...
		if (isset($this->request->post['payu_merchant'])) {
			$this->data['payu_merchant'] = $this->request->post['payu_merchant'];
		} else {
			$this->data['payu_merchant'] = $this->config->get('payu_merchant');
		}
		
		if (isset($this->request->post['payu_salt'])) {
			$this->data['payu_salt'] = $this->request->post['payu_salt'];
		} else {
			$this->data['payu_salt'] = $this->config->get('payu_salt');
		}
