...
class ControllerCheckoutRegister extends Controller {
	...
	public function validate() {
		...
		$json = array();
		//Hardcoding country id to 99
		$this->request->post['country_id'] = 99;
		$this->request->post['zone_id'] = 99;
		...
		if (!$json) {					
			...
			if (!isset($this->request->post['states_id']) || $this->request->post['states_id'] == '') {
				$json['error']['states'] = $this->language->get('error_state');
			}

			if (!isset($this->request->post['locality_id']) || $this->request->post['locality_id'] == '') {
				$json['error']['locality'] = $this->language->get('error_locality');
			}
